...
// CONFIG MESSAGES
export const CONFIG_INTRO_MESSAGE = "GptCommit Config 🛠️";
export const YOUR_API_KEY = "Your OpenAi Api key 🔑";
...
export const MORE_THAN_TEN_COMMIT_MESSAGES = "Generating more than 10 commit messages is not allowed 😔";
export const CONFIG_OUTRO_MESSAGE = "You have successfully configured GptCommit 🍺";
// COMMIT PAGE 
export const COMMIT_INTRO_MESSAGE = "GPT-3 Commit Message Generator";
export const SELECT_FILES_TO_ADD = "Select files to add 🗃️";
